...
public class Constant {
    ...
    public static class AD_PALN_TABLE_INFO {
        public static final String TABLE_NAME = "ad_plan";

        public static final String COLUMN_ID = "id";
        public static final String COLUMN_USER_ID = "user_id";
        public static final String COLUMN_STATUS = "plan_status";
    ...
    public static class AD_CREATIVE_TABLE_INFO {
        ...
        public static final String COLUMN_METERIAL_TYPE = "material_type";
    ...
    static{
        ...
        table2Db.put(AD_PALN_TABLE_INFO.TABLE_NAME, DB_NAME);
